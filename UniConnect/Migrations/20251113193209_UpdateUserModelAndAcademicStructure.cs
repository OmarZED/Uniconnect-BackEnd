...
{
    /// <inheritdoc />
    public partial class UpdateUserModelAndAcademicStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropCheckConstraint(
                name: "CK_User_AdminType",
                table: "AspNetUsers");

            migrationBuilder.DropCheckConstraint(
                name: "CK_User_Student_NoAdminType",
                table: "AspNetUsers");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_User_AdminType",
                table: "AspNetUsers",
                sql: "NOT (Role = 'Admin' AND AdminType IS NULL)");

            migrationBuilder.AddCheckConstraint(
                name: "CK_User_Student_NoAdminType",
                table: "AspNetUsers",
                sql: "NOT (Role = 'Student' AND AdminType IS NOT NULL)");
        }
    }
}

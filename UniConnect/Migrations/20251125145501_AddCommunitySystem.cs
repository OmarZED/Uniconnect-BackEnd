        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentGroupId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    AllowPosts = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    AutoJoin = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Communities_StudentGroups_StudentGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Communities_StudentGroupId",
                table: "Communities",
